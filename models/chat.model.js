...
const chatSchema = new Schema(
  {
    from: { type: Schema.Types.ObjectId, ref: 'User', required: true }, // sender's userId (can be ObjectId if referencing User model)
    to: { type: Schema.Types.ObjectId, refPath: 'toRef', required: true }, // recipient's userId or groupId (can be ObjectId if referencing Group/User)
